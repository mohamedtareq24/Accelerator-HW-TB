...
################################################################
# This is a generated script based on design: fir_demo
#
...
\
  ...
  # Create instance: axi_bram_dst, and set properties
  set axi_bram_dst [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 axi_bram_dst ]

  # Create instance: axi_bram_src, and set properties
  set axi_bram_src [ create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.1 axi_bram_src ]
  ...
  set block_name fir_top
  set block_cell_name fir_top_0
  if { [catch {set fir_top_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
  ...
  # Create instance: axi_bram_dst_bram, and set properties
  set axi_bram_dst_bram [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 axi_bram_dst_bram ]
  set_property CONFIG.Memory_Type {True_Dual_Port_RAM} $axi_bram_dst_bram
  ...
  # Create instance: axi_bram_src_bram, and set properties
  set axi_bram_src_bram [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 axi_bram_src_bram ]
  set_property CONFIG.Memory_Type {True_Dual_Port_RAM} $axi_bram_src_bram
  ...
  connect_bd_intf_net -intf_net axi_bram_dst_BRAM_PORTA [get_bd_intf_pins axi_bram_dst_bram/BRAM_PORTA] [get_bd_intf_pins axi_bram_dst/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_dst_BRAM_PORTB [get_bd_intf_pins axi_bram_dst_bram/BRAM_PORTB] [get_bd_intf_pins axi_bram_dst/BRAM_PORTB]
  connect_bd_intf_net -intf_net axi_bram_src_BRAM_PORTA [get_bd_intf_pins axi_bram_src_bram/BRAM_PORTA] [get_bd_intf_pins axi_bram_src/BRAM_PORTA]
  connect_bd_intf_net -intf_net axi_bram_src_BRAM_PORTB [get_bd_intf_pins axi_bram_src_bram/BRAM_PORTB] [get_bd_intf_pins axi_bram_src/BRAM_PORTB]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins fir_top_0/s_axis] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
connect_bd_intf_net -intf_net [get_bd_intf_nets axi_dma_0_M_AXIS_MM2S] [get_bd_intf_pins fir_top_0/s_axis] [get_bd_intf_pins system_ila_0/SLOT_0_AXIS]
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins axi_bram_dst/S_AXI]
  connect_bd_intf_net -intf_net axi_interconnect_1_M00_AXI [get_bd_intf_pins axi_interconnect_1/M00_AXI] [get_bd_intf_pins axi_bram_src/S_AXI]
  connect_bd_intf_net -intf_net fir_top_0_m_axis [get_bd_intf_pins fir_top_0/m_axis] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
connect_bd_intf_net -intf_net [get_bd_intf_nets fir_top_0_m_axis] [get_bd_intf_pins fir_top_0/m_axis] [get_bd_intf_pins system_ila_0/SLOT_1_AXIS]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets fir_top_0_m_axis]
...
connect_bd_intf_net -intf_net [get_bd_intf_nets ps8_0_axi_periph_M00_AXI] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI] [get_bd_intf_pins system_ila_0/SLOT_2_AXI]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M01_AXI [get_bd_intf_pins ps8_0_axi_periph/M01_AXI] [get_bd_intf_pins fir_top_0/s_axi]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M02_AXI [get_bd_intf_pins ps8_0_axi_periph/M02_AXI] [get_bd_intf_pins axi_interconnect_0/S01_AXI]
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M03_AXI [get_bd_intf_pins ps8_0_axi_periph/M03_AXI] [get_bd_intf_pins axi_interconnect_1/S01_AXI]
  ...
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins rst_ps8_0_100M/peripheral_aresetn] [get_bd_pins axi_bram_dst/s_axi_aresetn] [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_bram_src/s_axi_aresetn] [get_bd_pins axi_interconnect_1/M00_ARESETN] [get_bd_pins axi_interconnect_1/S00_ARESETN] [get_bd_pins fir_top_0/aresetn] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins axi_interconnect_0/ARESETN] [get_bd_pins axi_interconnect_1/ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins axi_interconnect_0/S01_ARESETN] [get_bd_pins axi_interconnect_1/S01_ARESETN] [get_bd_pins ps8_0_axi_periph/M03_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins system_ila_0/resetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins axi_bram_dst/s_axi_aclk] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins axi_bram_src/s_axi_aclk] [get_bd_pins axi_interconnect_1/M00_ACLK] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_interconnect_1/S00_ACLK] [get_bd_pins fir_top_0/aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_1/ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins axi_interconnect_0/S01_ACLK] [get_bd_pins axi_interconnect_1/S01_ACLK] [get_bd_pins ps8_0_axi_periph/M03_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins system_ila_0/clk]
  ...
  assign_bd_address -offset 0xA0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_dst/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0002000 -range 0x00002000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_bram_src/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0010000 -range 0x00002000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0xA0020000 -range 0x00002000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs fir_top_0/s_axi/reg0] -force
  assign_bd_address -offset 0xA0002000 -range 0x00002000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs axi_bram_src/S_AXI/Mem0] -force
  assign_bd_address -offset 0xA0000000 -range 0x00002000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs axi_bram_dst/S_AXI/Mem0] -force
